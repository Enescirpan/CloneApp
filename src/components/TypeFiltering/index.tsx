...
function index() {
  ...
  return ( 
   <ScrollView style={{width:'100%',height:height*0.072,backgroundColor:'white',paddingVertical:height*0.013,paddingHorizontal:12,borderBottomColor:'lightgrey',borderBottomWidth:0.6}} showsHorizontalScrollIndicator={false} bounces={true} horizontal={true}>
